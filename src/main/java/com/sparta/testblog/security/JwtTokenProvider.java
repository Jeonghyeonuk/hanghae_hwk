...
public class JwtTokenProvider {
    private static final String JWT_SECRET = "aaaaaaaaaaqqqqqqqqqqwwwwwwwwwweeqqqqwwwweeee";

//    static String encoded = Base64.getEncoder().encodeToString(JWT_SECRET.getBytes());
